...
ggplot(aes(x = mean_dep_delay,y = cancelledperc)) + 
  ...
  geom_smooth()
```
arr_time is the most important column to determine if the flight was cancelled. There seems to be a positive correlation between cancelled flights and arr delay